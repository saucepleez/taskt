...
namespace taskt.Core.Automation.Commands
{
    ...
    public class ExcelGetDataRangeCommand : ScriptCommand
    {
        [XmlAttribute]
        ...
        public ExcelGetDataRangeCommand()
        {
        ...
        public override void RunCommand(object sender)
        {
            ...
            Microsoft.Office.Interop.Excel.Worksheet sheet = excelInstance.ActiveSheet;
            DataTable dt = new DataTable();
            
            DataTable table = new DataTable();
            foreach(object item in dt.Columns)
            {
            ...
            foreach (object item in requiredData.Columns)
            {
                Console.WriteLine("Test" + item.ToString());
            }
            var cellValue = 2;
