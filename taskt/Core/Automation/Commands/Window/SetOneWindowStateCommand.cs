...
namespace taskt.Core.Automation.Commands
{
    ...
    [Attributes.ClassAttributes.CommandSettings("Set One Winodw State")]
    ...
    public sealed class SetOneWindowState : AOneWindowNameActionCommands, IWindowStateProperties
    {
        [XmlAttribute]
