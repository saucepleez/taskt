...
namespace taskt.Core.Automation.Commands
{
    ...
    public class ExecuteDLLCommand : ScriptCommand
    {
        ...
        [PropertyUIHelper(PropertyUIHelper.UIAdditionalHelperType.ShowDLLExplorer)]
        ...
        [SampleUsage("")]
        [Remarks("")]
        [PropertyUIHelper(PropertyUIHelper.UIAdditionalHelperType.GenerateDLLParameters)]
