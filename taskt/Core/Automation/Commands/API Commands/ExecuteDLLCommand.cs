...
namespace taskt.Core.Automation.Commands
{
    ...
    [Attributes.ClassAttributes.Description("This command allows user to invoke a method of a specific class from DLL")]
    [Attributes.ClassAttributes.UsesDescription("Use this command to invoke a specific method of a class from DLL (Library) File")]
