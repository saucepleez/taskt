...
namespace taskt.Core.Automation.Commands
{
    ...
    [Attributes.ClassAttributes.Description("This command allows user to call REST API.")]
    [Attributes.ClassAttributes.UsesDescription("Use this command when you want to call a REST API with specific HTTP method")]
    [Attributes.ClassAttributes.ImplementationDescription("This command implements 'RestRequest' to call a REST API Endpoint with specific HTTP 'Method'")]
    public class ExecuteRESTAPICommand : ScriptCommand
    {
        ...
        {
            this.CommandName = "ExecuteRESTAPICommand";
        ...
        private string ExecuteRESTRequest(object sender)
        {
            //get engine instance
