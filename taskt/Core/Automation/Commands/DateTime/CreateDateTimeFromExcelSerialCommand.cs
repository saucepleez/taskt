...
namespace taskt.Core.Automation.Commands
{
    ...
    public class CreateDateTimeFromExcelSerialCommand : ScriptCommand
    {
        ...
        [PropertyDetailSampleUsage("**43210**", "Specify **43210** for DateTime. It's means 2018-04-20.")]
        [PropertyDetailSampleUsage("**{{{vSearil}}}", "Specify Value of Variable **vSerial** for DateTime")]
        [Remarks("")]
