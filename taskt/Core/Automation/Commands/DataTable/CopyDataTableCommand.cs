...
namespace taskt.Core.Automation.Commands
{
    ...
    public class CopyDataTableCommand : ScriptCommand
    {
        ...
        [XmlAttribute]
        [Attributes.PropertyAttributes.PropertyDescription("Please Specify the Variable Name To Assign the copied DataTable")]
        [Attributes.PropertyAttributes.InputSpecification("Select or provide a variable from the variable list")]
        [Attributes.PropertyAttributes.SampleUsage("**vNewDataTable** or **{{{vNewDataTable}}}**")]
