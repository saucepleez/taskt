...
namespace taskt.Core.Automation.Commands
{
    ...
    [Attributes.ClassAttributes.Description("This command allows you to filter Filter Rows by reference to Column values.")]
    [Attributes.ClassAttributes.UsesDescription("Use this command when you want to filter Filter Rows by reference to Column values.")]
    ...
    public class FilterDataTableRowByColumnValueCommand : ScriptCommand
    {
        ...
        [XmlAttribute]
        [PropertyDescription("Please select a DataTable Variable Name of the Filtered List")]
        [InputSpecification("")]
