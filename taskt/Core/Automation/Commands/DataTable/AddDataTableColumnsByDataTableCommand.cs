...
namespace taskt.Core.Automation.Commands
{
    ...
    public class AddDataTableColumnsByDataTableCommand : ScriptCommand
    {
        [XmlAttribute]
        ...
        public AddDataTableColumnsByDataTableCommand()
        {
            this.CommandName = "AddDataTableColumnsByDataTableCommand";
            this.SelectionName = "Add DataTable Columns By DataTable";
        ...
        public override void RunCommand(object sender)
        {
            ...
            switch (ifRowNotEnough)
            {
                ...
                case "error":
                    break;
                default:
                    throw new Exception("Strange value If the number of rows is less than the DataTable to set new Column " + v_IfColumnExists);
                    break;
            }
            ...
            switch (ifListNotEnough)
            {
                ...
                case "error":
                    break;
                default:
                    throw new Exception("Strange value If the number of DataTable to set new Column is less than the rows " + v_IfColumnExists);
                    break;
            }
