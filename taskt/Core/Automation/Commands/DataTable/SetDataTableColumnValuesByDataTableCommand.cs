...
namespace taskt.Core.Automation.Commands
{
    ...
    public class SetDataTableColumnValuesByDataTableCommand : ScriptCommand
    {
        ...
        [XmlAttribute]
        [Attributes.PropertyAttributes.PropertyDescription("If the number of rows is less than the DataTable to set (Default is Ignore)")]
        [Attributes.PropertyAttributes.InputSpecification("")]
        ...
        [XmlAttribute]
        [Attributes.PropertyAttributes.PropertyDescription("If the number of DataTable items is less than the rows to setted DataTable (Default is Ignore)")]
        [Attributes.PropertyAttributes.InputSpecification("")]
