...
namespace taskt.Core.Automation.Commands
{
    ...
    public class FolderDialogCommand : ScriptCommand
    {
        [XmlAttribute]
        [Attributes.PropertyAttributes.PropertyDescription("Please select the variable to receive folder path")]
