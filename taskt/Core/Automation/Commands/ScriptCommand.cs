...
namespace taskt.Core.Automation.Commands
{
    ...
    [XmlInclude(typeof(CatchCommand))]
    [XmlInclude(typeof(FinallyCommand))]
    [XmlInclude(typeof(EndTryCommand))]
    [XmlInclude(typeof(ThrowCommand))]
    [XmlInclude(typeof(RethrowCommand))]
    [XmlInclude(typeof(BeginRetryCommand))]
    [XmlInclude(typeof(EndRetryCommand))]
