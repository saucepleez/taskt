...
namespace taskt.Core.Automation.Commands
{
    ...
    [Attributes.ClassAttributes.Description("This command allows you to Attach to the running WebBrowser and Create an Instance.")]
    [Attributes.ClassAttributes.UsesDescription("Use this command when you want to Attach to the running WebBrowser and Create an Instance.")]
    [Attributes.ClassAttributes.ImplementationDescription("Supported only on Chrome and Edge.Specifying parameters **--remote-debugging-port** and **--user-data-dir** is required.")]
    [Attributes.ClassAttributes.CommandIcon(nameof(Properties.Resources.command_web))]
    [Attributes.ClassAttributes.EnableAutomateRender(true)]
    [Attributes.ClassAttributes.EnableAutomateDisplayText(true)]
    public sealed class SeleniumBrowserAttachCreateWebBrowserInstanceCommand : ASeleniumCreateWebDriverCommands
    {
        //[XmlAttribute]
