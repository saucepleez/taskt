...
namespace taskt.Core.Automation.Commands
{
    ...
    public sealed class SeleniumBrowserGetWebElementsValueAsDictionaryCommand : ASeleniumGetMultiWebElementsValueAsSomethingCommands, IDictionaryResultProperties
    {
        //[XmlAttribute]
