...
namespace taskt.Core.Automation.Commands
{
    ...
    [Attributes.ClassAttributes.CommandSettings("Get Window And Tab URLs As JSON")]
    [Attributes.ClassAttributes.Description("This command allows you to Get Web Browser URLs of Windows and Tabs.")]
    [Attributes.ClassAttributes.UsesDescription("Use this command when you want to Get Web Browser URLs of Windows and Tabs.")]
    ...
    public sealed class SeleniumBrowserGetWindowAndTabURLsAsJSONCommand : ScriptCommand
    {
        ...
        public override void RunCommand(Engine.AutomationEngineInstance engine)
        {
            ...
            {
                var getURLs = new SeleniumBrowserGetWindowAndTabURLsAsListCommand()
                {
                    v_InstanceName = this.v_InstanceName,
                    v_Result = myList.VariableName,
                };
                getURLs.RunCommand(engine);
