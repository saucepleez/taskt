...
namespace taskt.Core.Automation.Commands
{
    ...
    public class RemoveDictionaryValueCommand : ScriptCommand
    {
        ...
        [XmlAttribute]
        [Attributes.PropertyAttributes.PropertyDescription("Please Remove the key")]
        ...
        {
            this.CommandName = "RemoveDictionaryValueCommand";
        ...
        {
            return base.GetDisplayValue() + $" [From: {v_DictionaryName}, Remove Key: {v_Key}";
        }
    }
}
