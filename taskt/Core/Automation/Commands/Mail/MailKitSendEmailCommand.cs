...
namespace taskt.Core.Automation.Commands
{
    ...
    public class MailKitSendEmailCommand : ScriptCommand
    {
        ...
        [SampleUsage("**myRobot@company.com** or **{{{vMail}}}**")]
        [Remarks("")]
        [PropertyShowSampleUsageInDescription(true)]
        ...
        [SampleUsage("**jason@company.com** or **{{{vMail}}}**")]
        [Remarks("")]
        [PropertyShowSampleUsageInDescription(true)]
        ...
        [PropertyUIHelper(PropertyUIHelper.UIAdditionalHelperType.ShowVariableHelper)]
        [InputSpecification("Specify the destination email that should be addressed.")]
        [SampleUsage("**rckt@company.com** or **{{{vMail}}}**")]
        [Remarks("")]
        [PropertyShowSampleUsageInDescription(true)]
        ...
        [PropertyUIHelper(PropertyUIHelper.UIAdditionalHelperType.ShowVariableHelper)]
        [InputSpecification("Specify the destination email that should be addressed.")]
        [SampleUsage("**rncn@company.com** or **{{{vMail}}}**")]
        [Remarks("")]
        [PropertyShowSampleUsageInDescription(true)]
        [PropertyIsOptional(true)]
        [PropertyTextBoxSetting(1, false)]
