...
namespace taskt.Core.Automation.Commands
{
    ...
    [Attributes.ClassAttributes.CommandSettings("UIElement Action After Search UIElement By XPath From Window Name")]
    ...
    public sealed class UIAutomationUIElementActionAfterSearchUIElementByXPathFromWindowNameCommand : AUIElementActionFromWindowSomethingByXPathCommands, IOneWindowNameProperties
    {
        //[XmlAttribute]
        ...
        public UIAutomationUIElementActionAfterSearchUIElementByXPathFromWindowNameCommand()
        {
        }
