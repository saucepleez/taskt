...
namespace taskt.Core.Automation.Commands.UIAutomationGroup
{
    ...
    /// </summary>
    public abstract class ADescendantsSearchUIElementsFromWindowHandleByTreeWalkerCommands : ADescendantsSearchUIElementsFromSomethingByTreeWalkerCommands, IWindowHandleProperties, IWindowUIElementResultProperties
    {
        [XmlAttribute]
