...
namespace taskt.Core.Automation.Commands
{
    ...
    public sealed class UIAutomationGetPropertyValueFromUIElementCommand : AGetFromUIElementCommands, IResultProperties
    {
        //[XmlAttribute]
        ...
        public override string v_WhenValueCanNotRetrieved { get; set; }
            ...
            this.UIElementAction(engine,
                new Action<AutomationElement>((targetElement) =>
                {
                    ...
                    else
                    {
                        ...
                        {
                            this.ValueCanNotRetrievedProcess($"{propName} Property", new Action(() =>
                            {
