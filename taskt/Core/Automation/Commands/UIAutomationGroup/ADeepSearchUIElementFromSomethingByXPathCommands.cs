...
namespace taskt.Core.Automation.Commands.UIAutomationGroup
{
    ...
    /// </summary>
    public abstract class ADeepSearchUIElementFromSomethingByXPathCommands : ACoreSearchUIElementFromSomethingByXPathCommands, IUIElementDeepSearchSomewayProperties
    {
        [XmlAttribute]
