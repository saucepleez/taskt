...
namespace taskt.Core.Automation.Commands
{
    ...
    public sealed class UIAutomationSearchUIElementFromWindowNameByXPathCommand : ADescendantsSearchUIElementsFromWindowNameByXPathCommands, IResultProperties
    {
        //[XmlAttribute]
        ...
        public override void RunCommand(Engine.AutomationEngineInstance engine)
        {
            ...
            {
                var winSearch = new UIAutomationGetWindowUIElementFromWindowNameCommand()
                {
