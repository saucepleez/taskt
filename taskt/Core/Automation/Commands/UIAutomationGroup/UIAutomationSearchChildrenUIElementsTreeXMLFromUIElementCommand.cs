...
namespace taskt.Core.Automation.Commands
{
    ...
    [Attributes.ClassAttributes.CommandSettings("Search Children UIElements Tree XML From UIElement")]
    [Attributes.ClassAttributes.Description("This command allows you to Search Children UIElements Tree XML from UIElement.")]
    [Attributes.ClassAttributes.ImplementationDescription("Use this command when you want to Search Children UIElements Tree XML from UIElement. XML content is based on WinAppDriver UI Recorder.")]
    [Attributes.ClassAttributes.CommandIcon(nameof(Properties.Resources.command_window))]
    [Attributes.ClassAttributes.EnableAutomateRender(true)]
    [Attributes.ClassAttributes.EnableAutomateDisplayText(true)]
    public sealed class UIAutomationSearchChildrenUIElementsTreeXMLFromUIElementCommand : ADoSomethingUIElementCommands, IUIElementChildrenSearchSomewayProperties, IResultProperties
    {
        [XmlAttribute]
        ...
        public UIAutomationSearchChildrenUIElementsTreeXMLFromUIElementCommand()
        {
        }
        ...
        public override void RunCommand(Engine.AutomationEngineInstance engine)
        {
            ...
            var cmd = new UIAutomationSearchChildUIElementFromUIElementByXPathCommand()
            {
            ...
            (var xml, _) = cmd.CreateChildrenXMLCore(targetElement, timeFunc, engine);
