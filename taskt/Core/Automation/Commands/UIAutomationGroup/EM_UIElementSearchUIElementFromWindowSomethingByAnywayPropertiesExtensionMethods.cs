...
namespace taskt.Core.Automation.Commands.UIAutomationGroup
{
    public static class EM_UIElementSearchUIElementFromWindowSomethingByAnywayPropertiesExtensionMethods
    {
        ...
        /// <param name="searchFunc">InnerScriptVariable is variable to store Window UIElement</param>
        /// <param name="actionFunc">InnerScriptVariable is variable to store Window UIElement</param>
