...
namespace taskt.Core.Automation.Commands
{
    ...
    public class RemoveListItemCommand : ScriptCommand
    {
        ...
        [XmlAttribute]
        [Attributes.PropertyAttributes.PropertyDescription("Please Remove the index of the List item.")]
        [Attributes.PropertyAttributes.PropertyUIHelper(Attributes.PropertyAttributes.PropertyUIHelper.UIAdditionalHelperType.ShowVariableHelper)]
        ...
        {
            this.CommandName = "RemoveListItemCommand";
            this.SelectionName = "Remove List Item";
        ...
        public override void RunCommand(object sender)
        {
            ...
            if (_index < listToIndex.Count)
            {
                listToIndex.RemoveAt(_index);
            }
            else
            {
        ...
        {
            return base.GetDisplayValue() + $" [From '{v_ListName}', Remove At: '{_index}']";
        }
