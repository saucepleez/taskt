...
namespace taskt.Core.Automation.Commands
{
    ...
    [Attributes.ClassAttributes.Description("This command allows you to get count of words from a text (string)")]
    [Attributes.ClassAttributes.UsesDescription("Use this command when you want to get count of words from text")]
