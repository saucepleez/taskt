...
namespace taskt.Core.Automation.Commands
{
    ...
    [Attributes.ClassAttributes.Description("This command allows you to check AutomationElement existance from AutomationElement using by XPath.")]
    [Attributes.ClassAttributes.ImplementationDescription("Use this command when you want to check AutomationElement existance from AutomationElement using by XPath.")]
