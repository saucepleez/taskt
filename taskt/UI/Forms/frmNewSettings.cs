...
namespace taskt.UI.Forms
{
    public partial class frmNewSettings : ThemedForm
    {
        ...
        private void showEditorCommandEditorSettings()
        {
            ...
            createCheckBox("chkPliteTextInDescription", "Try Plite Text In Description (beta)", newAppSettings.ClientSettings, nameof(newAppSettings.ClientSettings.ShowPoliteTextInDescription), true);
