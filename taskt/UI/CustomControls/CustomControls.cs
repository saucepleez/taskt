...
namespace taskt.UI
{
    public static class Images
    {
        ...
        private static Dictionary<string, string> imageCommandTable = new Dictionary<string, string>()
        {
            ...
            {nameof(UIAutomationSearchElementAndWindowByXPathCommand), "taskt.Properties.Resources.command_window"},
            ...
            {nameof(SeleniumBrowserGetAnWebElementValuesAsListCommand), "taskt.Properties.Resources.command_web"},
