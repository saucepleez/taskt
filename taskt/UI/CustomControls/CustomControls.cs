...
namespace taskt.UI
{
    public static class Images
    {
        public static Dictionary<string, Image> UIImageDictionary()
        {
            ...
            uiImages.Add("PauseScriptCommand", taskt.Properties.Resources.command_pause);
            uiImages.Add("SetEngineDelayCommand", taskt.Properties.Resources.command_pause);
            uiImages.Add("AddCodeCommentCommand", taskt.Properties.Resources.command_comment);
            ...
            uiImages.Add("WaitForWindowToExistCommand", taskt.Properties.Resources.command_window);            
            ...
            uiImages.Add("ShowMessageCommand", taskt.Properties.Resources.command_comment);
            ...
            uiImages.Add("SetVariableCommand", taskt.Properties.Resources.command_function);
            ...
            uiImages.Add("StopCurrentTaskCommand", taskt.Properties.Resources.command_stop_process);
            uiImages.Add("InputCommand", taskt.Properties.Resources.command_input);
            uiImages.Add("CloseWindowCommand", taskt.Properties.Resources.command_window_close);
            uiImages.Add("IECreateBrowserCommand", taskt.Properties.Resources.command_web);
            uiImages.Add("IENavigateToURLCommand", taskt.Properties.Resources.command_web);
            uiImages.Add("IEFindBrowserCommand", taskt.Properties.Resources.command_web);
            uiImages.Add("IECloseBrowserCommand", taskt.Properties.Resources.command_window_close);
            uiImages.Add("IEElementActionCommand", taskt.Properties.Resources.command_web);
            uiImages.Add("SendKeystrokesCommand", taskt.Properties.Resources.command_input);
            ...
            uiImages.Add("GetClipboardTextCommand", taskt.Properties.Resources.command_files);
            uiImages.Add("SetClipboardTextCommand", taskt.Properties.Resources.command_files);
            ...
            uiImages.Add("ExcelActivateCellCommand", taskt.Properties.Resources.command_spreadsheet);
            ...
            uiImages.Add("ExcelWriteCellCommand", taskt.Properties.Resources.command_spreadsheet);
            ...
            uiImages.Add("ExcelSaveWorkbookAsCommand", taskt.Properties.Resources.command_spreadsheet);
            uiImages.Add("ExcelDeleteRowCommand", taskt.Properties.Resources.command_spreadsheet);
            uiImages.Add("ExcelDeleteRangeCommand", taskt.Properties.Resources.command_spreadsheet);
            uiImages.Add("ExcelGetLastRowIndexCommand", taskt.Properties.Resources.command_spreadsheet);
            uiImages.Add("ExcelSaveWorkbookCommand", taskt.Properties.Resources.command_spreadsheet);
            ...
            uiImages.Add("WordSaveDocumentCommand", taskt.Properties.Resources.command_files);
            uiImages.Add("WordSaveDocumentAsCommand", taskt.Properties.Resources.command_files);
            ...
            uiImages.Add("MergeDataTableCommand", taskt.Properties.Resources.command_spreadsheet);
            uiImages.Add("SeleniumCreateBrowserCommand", taskt.Properties.Resources.command_web);
            uiImages.Add("SeleniumNavigateToURLCommand", taskt.Properties.Resources.command_web);
            uiImages.Add("SeleniumNavigateForwardCommand", taskt.Properties.Resources.command_web);
            uiImages.Add("SeleniumNavigateBackCommand", taskt.Properties.Resources.command_web);
            uiImages.Add("SeleniumRefreshCommand", taskt.Properties.Resources.command_web);
            uiImages.Add("SeleniumCloseBrowserCommand", taskt.Properties.Resources.command_window_close);
            uiImages.Add("SeleniumElementActionCommand", taskt.Properties.Resources.command_web);
            uiImages.Add("SeleniumExecuteScriptCommand", taskt.Properties.Resources.command_script);
            uiImages.Add("SeleniumSwitchBrowserWindowCommand", taskt.Properties.Resources.command_window);
            uiImages.Add("SeleniumSwitchBrowserFrameCommand", taskt.Properties.Resources.command_window);
            uiImages.Add("SeleniumGetBrowserInfoCommand", taskt.Properties.Resources.command_web);
            ...
            uiImages.Add("ReplaceTextCommand", taskt.Properties.Resources.command_string);
            ...
            uiImages.Add("TakeScreenshotCommand", taskt.Properties.Resources.command_camera);
            uiImages.Add("PerformOCRCommand", taskt.Properties.Resources.command_camera);
            ...
            uiImages.Add("GetBotStoreDataCommand", taskt.Properties.Resources.command_server);
            ...
            uiImages.Add("LaunchRemoteDesktopCommand", taskt.Properties.Resources.command_system);
            uiImages.Add("OSVariableCommand", taskt.Properties.Resources.command_system);
            uiImages.Add("GenerateNLGPhraseCommand", taskt.Properties.Resources.command_nlg);
            uiImages.Add("SetNLGParameterCommand", taskt.Properties.Resources.command_nlg);
            uiImages.Add("CreateNLGInstanceCommand", taskt.Properties.Resources.command_nlg);
            ...
            uiImages.Add("DefineDatabaseConnectionCommand", taskt.Properties.Resources.command_database);
            uiImages.Add("ExecuteDatabaseQueryCommand", taskt.Properties.Resources.command_database);
            ...
            uiImages.Add("LoadDictionaryCommand", taskt.Properties.Resources.command_spreadsheet);
