...
namespace taskt.UI
{
    public static class Images
    {
        ...
        private static Dictionary<string, string> imageCommandTable = new Dictionary<string, string>()
        {
            ...
            {"SeleniumBrowserGetAElementValuesAsDataTableCommand", "taskt.Properties.Resources.command_web"},
            {"SeleniumBrowserGetAElementValuesAsDictionaryCommand", "taskt.Properties.Resources.command_web"},
            {"SeleniumBrowserGetAElementValuesAsListCommand", "taskt.Properties.Resources.command_web"},
